...
import com.example.home.solarinstalation.Model.DigitalClient;
...
public class Signature extends AppCompatActivity {
    ...
    String address;
    Bitmap bitmap;
    String DIRECTORY = Environment.getExternalStorageDirectory().getPath() + "/InstallSignature/";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        deviceId=String.valueOf(bundle.getString("deviceId"));
        ti=(TextView)findViewById(R.id.titleee);
        ti.setText(id);
    ...
    public class signature extends View {
        ...
        public void save(View v, String StoredPath) {
            ...
            try {
                ...
                if (InternetConnection.checkConnection(Signature.this)) {
                    /******************Retrofit***************/
                    upload(StoredPath);

                } else {
                    Toast.makeText(Signature.this,R.string.string_internet_connection_warning,Toast.LENGTH_LONG).show();
    ...
    private void upload(String storedPath) {
        ...
        DigitalApi service = DigitalClient.getApiService();
        ...
        Call<UploadImageResult> resultCall = service.uploadImage(body,id,deviceId);
        resultCall.enqueue(new Callback<UploadImageResult>() {
            ...
            public void onResponse(Call<UploadImageResult> call, Response<UploadImageResult> response) {
                if(response.isSuccessful()){
                    ...
                    Toast.makeText(Signature.this,"Successfully Uploaded",Toast.LENGTH_LONG).show();
                }
                else {
            ...
            public void onFailure(Call<UploadImageResult> call, Throwable t) {
                ...
                Toast.makeText(Signature.this,t.getMessage(),Toast.LENGTH_LONG).show();
